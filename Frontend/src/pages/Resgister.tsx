...
<form className="flex flex-col gap-5" onSubmit={onSubmit}>
    ...
    <label className="text-gray-700 text-sm font-bold flex-1" >Password
        ...
        minLength:{value:6,message:"Password must be atleast 6 characters"}})}></input>
    ...
    <span>
        <button type="submit" className="bg-blue-600 text-white p-2 font-bold hover:bg-blue-500 text-xl">Create Account</button></span>     
</form>
)
}
